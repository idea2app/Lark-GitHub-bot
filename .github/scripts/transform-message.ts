  ...
  event_name === "push"
    ? {
        ...
        content: [
          [
            { tag: "text", text: "提交链接：" },
            { tag: "a", text: head_commit?.url, href: head_commit?.url },
          ],
          [
            { tag: "text", text: "代码分支：" },
            {
    ...
    ? {
        ...
        content: [
          [
            { tag: "text", text: "链接：" },
            { tag: "a", text: issue?.html_url, href: issue?.html_url },
          ],
          [
            { tag: "text", text: "作者：" },
            { tag: "a", text: issue?.user?.login, href: issue?.user?.html_url },
          ],
          [
            { tag: "text", text: "指派：" },
            {
    ...
    ? {
        ...
        content: [
          ...
          [
            ...
            {
              tag: "a",
              text: pull_request?.assignee?.login,
              href: pull_request?.assignee?.html_url,
            },
          ],
          [
            {
    ...
    ? {
        ...
        content: [
          [
            { tag: "text", text: "链接：" },
            { tag: "a", text: comment?.html_url, href: comment?.html_url },
          ],
          [
            { tag: "text", text: "作者：" },
            {
    ...
    ? {
        ...
        content: [
          [
            { tag: "text", text: "链接：" },
            { tag: "a", text: release?.html_url, href: release?.html_url },
          ],
          [
            { tag: "text", text: "作者：" },
            {
